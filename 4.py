...
users = [  # Список користувачів з їхніми датами народження
    ...
    {"name": "Jane Johnson", "birthday": "1990.03.05"},
    {"name": "Jane Williams", "birthday": "1990.03.07"},
    {"name": "Jane Brown", "birthday": "1990.03.19"},
]
...
def get_upcoming_birthdays(users, days=7):
    ...
    # TODO: Оформити в функцію ✅
    def find_upcoming_birthdays(prepared_users):
...
# Виклик функцій
    ...
    upcoming_birthdays = find_upcoming_birthdays(prepared_users)
    return upcoming_birthdays
